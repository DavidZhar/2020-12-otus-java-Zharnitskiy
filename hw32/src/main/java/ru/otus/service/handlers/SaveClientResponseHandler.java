...
public class SaveClientResponseHandler implements RequestHandler<Client> {
    private static final Logger logger = LoggerFactory.getLogger(SaveClientResponseHandler.class);
